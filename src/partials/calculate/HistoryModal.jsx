			...
			<Modal
				...
				<div className="fixed inset-0 flex items-center justify-center">
					<div className="bg-white overflow-y-scroll dark:bg-gray-800 p-6 border-2 border-black dark:border-white shadow-xl rounded-lg w-full h-full mx-auto relative min-h-[300px] max-h-[600px] min-w-[360px] max-w-[600px]">
						<div className="text-gray-800 dark:text-white sticky -top-6 py-4 bg-white dark:bg-gray-800/20 backdrop-blur-lg">
							Your Transaction History displays here
						</div>
									...
									.map((weighIn) => (
										<li
											...
											<div className="text-sm text-left">
												<span className="text-purple-400 font-bold">{weighIn.fish.name}</span> weighing{" "}
												<span className="text-purple-400 font-bold">{weighIn.kg}kg</span> was recorded at{" "}
