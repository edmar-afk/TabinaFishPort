						...
						<ul className="mt-3">
								...
								<NavLink
									...
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											<DashboardCustomizeOutlinedIcon className="text-gray-600" />
							...
							<li
								...
								<NavLink
									...
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											<PhishingSharpIcon className="text-gray-600" />
											<span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
												Fishermen List
											</span>
										</div>
							...
							<li
								...
								<NavLink
									...
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											<SailingOutlinedIcon className="text-gray-600" />
											<span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
												Registration
											</span>
										</div>
							...
							<li
								...
								<NavLink
									...
									<div className="flex items-center justify-between">
										<div className="grow flex items-center">
											<SetMealSharpIcon className="text-gray-600" />
											<span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
												Fisheries Report
											</span>
										</div>
