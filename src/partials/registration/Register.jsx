				...
				<div className="flex flex-row flex-wrap sm:flex-nowrap items-center bg-white dark:bg-gray-800 w-full shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
					<form className="sm:p-8 p-4 w-full">
						...
						<div className="grid lg:grid-cols-4 gap-6 mt-8">
							<div>
								<label className="text-gray-800 dark:text-white text-sm mb-2 block">Engine Make/Serial No.:</label>
								<input
									name="name"
									type="text"
									className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-purple-500"
							...
							<div>
								<label className="text-gray-800 dark:text-white text-sm mb-2 block">Cycle:</label>
								<input
									name="lname"
									type="text"
									className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-purple-500"
							...
							<div>
								<label className="text-gray-800 dark:text-white text-sm mb-2 block">Number of Cylinder:</label>
								<input
									name="lname"
									type="text"
									className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-purple-500"
							...
							<div>
								<label className="text-gray-800 dark:text-white text-sm mb-2 block">Number of Engine:</label>
								<input
									name="lname"
									type="text"
									className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-purple-500"
						...
						<div className="grid lg:grid-cols-2 gap-6 mt-8">
							<div>
								<label className="text-gray-800 dark:text-white text-sm mb-2 block">Former Owner:</label>
								<input
									name="name"
									type="text"
									className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-purple-500"
							...
							<div>
								<label className="text-gray-800 dark:text-white text-sm mb-2 block">Address:</label>
								<input
									name="lname"
									type="text"
									className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3 rounded-md outline-purple-500"
